...
class Simulator:
    ...
    def unzip(self):
        ...
        if suffix[-1] == 'zip':
            ...
            os.system("rm -rf " + self.useless_file)
        else:
            pass
    def preprocess(self):
        ...
        for i in range(0,r):
            for j in range(0,c):
                ...
                # print(len(algae))
        # print(len(algae_ts[0]))
        # print(type(algae_ts[0][0][0][0]))
        ...
        with open(self.config.result_file, 'w') as writer:
            with open(self.config.download_file) as reader:
                ...
                for i,line in enumerate(reader,1):
                    ...
                    fields = fields.strip() + ",%s=%s\n" % ("Active_energy_consume", _vs["Global_active_power"] * 1000 / 60 - _vs["Sub_metering_1"] - _vs["Sub_metering_2"] - _vs["Sub_metering_3"])
